...
start_postgres_slave1:
	ansible-playbook -i cm/inventory -u vagrant --private-key=.vagrant/machines/n2/virtualbox/private_key cm/scripts/start_postgres_slave.yml -vvvv
start_postgres_slave2:
	ansible-playbook -i cm/inventory -u vagrant --private-key=.vagrant/machines/n3/virtualbox/private_key cm/scripts/start_postgres_slave.yml -vvvv
